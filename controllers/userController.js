...
// const { oAuth2Client } = require("../utils/nodemailer");
  ...
  try {
    ...
    try {
      ...
      transport.sendMail(
        ...
        <a href="http://${req.headers.host}/user_auth/verify-email?token=${user.emailToken}">Click here to verify your account</a>
        <p>Cheers</p>
